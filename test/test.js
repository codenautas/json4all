...
var fixtures=[
    ...
    {name:'fecha'     ,value: new Date(1969, 5-1, 6)     , expectEncode: '{"$date":-20725200000}'},
    ...
    {name:'h1-EPJSON' ,value: {d:{$date:1456887600000},u:{$undefined:true}}},
    {name:'h2-EPJSON' ,value: {$escape:{d:{$date:1456887600000},u:{$undefined:true}}}},
    {name:'h3-EPJSON' ,value: {$escape:{$escape:{d:{$date:1456887600000},u:{$undefined:true},e:{$escape:true}}}}},
